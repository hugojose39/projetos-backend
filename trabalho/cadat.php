...
<body>
	...
	require("conexao.php");
	@$id= $_GET['id'];
	$sql = "SELECT * FROM endereco Where id_dados = ".$id;
	$query = mysqli_query($conexao, $sql);
	$consulta = mysqli_fetch_array($query);
	
	echo '<form name="form1" action="cadatualiza.php" method="POST">
			<input type="hidden" name="id_dados" value="'.$consulta["id_endereco"].'">
		<table border="1">
		<tr align="center">
			<td colspan="2">Atualizar dados</td>		
		</tr>
		<td>Rua: </td>
		<td><input type="text" name="rua" value="'.$consulta["rua"].'"></td>
	</tr>
	<tr>
	<td>Número: </td>
	<td><input type="text" name="numero" value="'.$consulta["numero"].'"></td>
</tr>
<tr>
<td>Bairro: </td>
<td><input type="text" name="bairro" value="'.$consulta["bairro"].'"></td>

</tr>
<tr>
<td>Cidade: </td>
<td><input type="text" name="cidade" value="'.$consulta["cidade"].'"></td>

</tr>
<tr>
<td>Estado: </td>
<td><input type="text" name="estado" value="'.$consulta["estado"].'"></td>
